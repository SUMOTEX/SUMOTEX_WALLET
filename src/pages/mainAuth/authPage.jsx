                ...
                state === 1 ? <Login changeAuthPage={changeAuthPage} /> :
                    state === 2 ? <Register changeAuthPage={changeAuthPage} /> :
                        state == 3 && value !== undefined ? <VerifyPage data={value} changeAuthPage={changeAuthPage} /> :
                            state == 4 ? <PaymentPage changeAuthPage={changeAuthPage} /> :
                                state == 5 ?
                                    <SuccessRequestPage changeAuthPage={changeAuthPage} /> :
                                    state == 6 ? <ResetPasswordPage changeAuthPage={changeAuthPage} /> :
                                        state == 7 ? <ResetPasswordSecondPage data={value} changeAuthPage={changeAuthPage} /> : null}
        </div>
    )
};
